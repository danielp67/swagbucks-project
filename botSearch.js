...
let dbNoms = ['aide','chef','enfant','garde','gauche','geste','gosse','livre','merci','mort','ombre','part','poche','professeur','tour','fois','madame','paix','voix','affaire','année','arme','armée','attention','balle','boîte','bouche','carte','cause','chambre','chance','chose','classe','confiance','couleur','cour','cuisine','dame','dent','droite','école','église','envie',
...
let dbVerbes = [
    'être','avoir','faire','dire','voir','prendre','pouvoir','parler','aller','savoir','donner','passer','mettre','partir','trouver','rire','vivre','laisser','rendre','sourire','venir','comprendre','penser','chercher','croire','entendre','tenir','demander','souvenir','attendre','sortir','regarder','jouer','écrire','connaître','devenir','rester','retrouver','entrer',
    ...
    'travailler','garder','marcher','imaginer','considérer','tendre','lever','tourner','gagner','recevoir','revoir','aider','créer','découvrir','compter','courir','rentrer','réaliser','toucher','finir','descendre','ajouter','présenter','essayer','coucher','occuper','asseoir','jeter','payer','définir','déjeuner','déjeûner','agir','choisir','distinguer','préparer',
    ...
    'étendre','mener','affirmer','réfléchir','chanter','vendre','traverser','fier','décider','entraîner','entrainer','avancer','refuser','abandonner','protéger','noter','remplir','fermer','dégager','ramener','poursuivre','couper','embrasser','décrire','répéter','organiser','vérifier','danser','espérer','frapper','accomplir','exister','avouer',
    ...
    'réveiller','écarter','proposer','calculer','diriger','posséder','retirer','durer','crever','résister','deviner','tromper','dresser','céder','craindre','prêter','couvrir','ménager','traîner','cesser','traduire','aborder','confondre','peindre','entreprendre','débarrasser','comparer','entretenir','amuser','plaindre','fabriquer','attaquer','combattre','accroître',
    ...
    'attribuer','souligner','épouser','adopter','interroger','révéler','éclairer','limiter','demeurer','libérer','inventer','consacrer','faciliter','ranger','plaire','goûter','gouter','rocher','effacer','communiquer','boucher','répartir','repartir','réunir','respecter','interpréter','forcer','contrôler','vaincre','ficher','lâcher','trembler','supprimer','identifier',
    ...
    'commander','valoir','reproduire','recueillir','taper','isoler','mentir','rattraper','multiplier','orienter','user','affronter','enseigner','falloir','enfermer','dessiner','favoriser','retomber','recourir','pratiquer','baisser','bénéficier','fonder','exiger','réparer','risquer','percevoir','comporter','vider','accéder','composer','formuler','caresser','signer',
    ...
    'clocher','boulanger','verser','refermer','repousser','obliger','pencher','informer','correspondre','conquérir','étouffer','déchiffrer','ressentir','sacrifier','mordre','désirer','excuser','encourager','subsister','explorer','nettoyer','délivrer','gêner','coller','avertir','ôter','élargir','intégrer','garantir','renouveler','oser','fouiller','répandre','résumer',
    'interdire','convenir','venger','surmonter','rédiger','contribuer','emprunter','défiler','agiter','revivre','signifier','flotter','défaire','croître','concilier','émettre','concentrer','suffire','renvoyer','renverser','commettre','inspirer','troubler','chauffer','balancer','réserver','soucier','mentionner','enregistrer','réchauffer',
    ...
    'dater','raser','solliciter','errer','honorer','féliciter','entourer','tâcher','tacher','pleuvoir','insérer','accommoder','énumérer','incliner','convertir','exploser','redire','méconnaître','rallier','nouer','aménager','viser','débrouiller','sombrer','masquer','ressusciter','buter','mépriser','découper','proclamer','menacer','mater','contrarier','réjouir',
